...
"""-----------------------------------------https://t.me/ClipmateMoviesAssistantbot --------------------------------------"""
...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="https://t.me/ClipmateMoviesAssistantbot")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('Support Group',url="https://t.me/sgrph"),
            InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="https://t.me/ClipmateMoviesAssistantbot")
        ],[
            InlineKeyboardButton('Use Me Here', url=f'https://t.me/sgrph')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
